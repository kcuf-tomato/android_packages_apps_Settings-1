...
public class SystemUpdatePreferenceController extends BasePreferenceController {
    ...
    private static final String OTA_BUILD_TYPE_PROP = "ro.stag.releasetype";
    private static final String OTA_APP_PACKAGE = "com.stag.ota";
    ...
    public int getAvailabilityStatus() {
        ...
        if (!mUm.isAdminUser() || !buildtype.equalsIgnoreCase("weekly")){
